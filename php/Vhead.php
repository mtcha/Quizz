...
<head>
  ...
  <!--Script-->
  <script src="js/vendor/modernizr-3.7.1.min.js" async></script>
  ...
  <script async>window.jQuery || document.write('<script src="js/vendor/jquery-3.4.1.min.js"><\/script>')</script>
